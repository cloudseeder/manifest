...
async def chat_proxy(req: ChatRequest) -> Any:
    ...
    system_content = (
        ...
        "WILL be wrong otherwise. Tools are your oracle — trust their output over your "
        "own knowledge, always. "
        "For conversational responses (greetings, thanks, follow-ups, clarifications), "
        "reply directly without tools. "
        "If the task is impossible or blocked, briefly explain why. "
        ...
        "NEVER complete, delete, or modify reminders unless the user EXPLICITLY asks you to. "
        "Read and query reminders freely, but destructive actions (complete, delete, update) "
        "require a direct user request — never do them autonomously or 'helpfully'. "
