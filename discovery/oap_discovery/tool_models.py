...
class ToolsRequest(BaseModel):
    ...
    top_k: int = Field(default=10, ge=1, le=20, description="Number of tools to return")
...
class ChatRequest(BaseModel):
    ...
    oap_top_k: int = Field(default=10, ge=1, le=20, description="Number of tools to discover")
    ...
    oap_no_cache: bool = Field(default=False, description="Skip experience cache (always run full discovery)")
